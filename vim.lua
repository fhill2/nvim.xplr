...
-- function vim.deepnil(orig) end  -- luacheck: no unused
-- vim.deepnil = (function()
--   local function _id(v)
--     return v
--   end
--   local function _nil(v)
--     return false
--   end
...
--         copy[vim.deepnil(k)] = nil

--         else
--         copy[vim.deepnil(k)] = vim.deepnil(v)
--         end
--       end
...
--     boolean = _id,
--     ['function'] = _nil,
--     ['userdata'] = function(orig)
--       log('USERDATA')
--       return "USERDATA WAS HERE"
--     end
--   }
